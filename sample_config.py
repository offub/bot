...
class Config(object):
    ...
    # set this with required off repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/offub/bot"
    )
    ...
    # if you need badoff plugins use the following vars
    BADOFF = os.environ.get("BADOFF", "no")
    BADOFF = bool(BADOFF and (BADOFF.lower() != "no"))
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "offuserbot")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/2d0affbb63ba34123b929.jpg"
    )
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-offuserbot-01-01
    ...
    BADOFF_REPO = os.environ.get("BADOFF_REPO", "https://github.com/offub/pack")
    if BADOFF_REPO and not url(BADOFF_REPO):
        BADOFF_REPO = "https://github.com/offub/pack"
    BADOFF_REPOBRANCH = os.environ.get("BADOFF_REPOBRANCH", "badoff")
