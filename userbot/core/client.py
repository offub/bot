...
class OffUserBotClient(TelegramClient):
    def off_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[here](https://t.me/offub)"
                        text = (
                            "**OffUserbot Error report**\n\n"
            ...
            if pattern is not None:
                ...
                if edited:
                    offub.add_event_handler(func, events.MessageEdited(**kwargs))
                offub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                offub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                offub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
OffUserBotClient.fast_download_file = download_file
OffUserBotClient.fast_upload_file = upload_file
OffUserBotClient.reload = restart_script
OffUserBotClient.get_msg_link = get_message_link
OffUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    OffUserBotClient.send_message = send_message
    OffUserBotClient.send_file = send_file
    OffUserBotClient.edit_message = edit_message
