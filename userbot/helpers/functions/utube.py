...
async def yt_search(off):
    try:
        off = urllib.parse.quote(off)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={off}"
        )
...
"""
async def yt_data(off):
    params = {"format": "json", "url": off}
    url = "https://www.youtube.com/oembed"  # yeah i am moha /:
