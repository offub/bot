...
from wand.image import Image as offimage

from .utils import _offutils
...
async def off_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def off_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = offimage(filename=picture_name)
    main_image.resize(
